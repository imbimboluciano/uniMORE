...
breed [youngers younger]
breed [workers worker]
breed [retireds retired]
...
to age-population
  ...
  ask youngers [
    ...
    if age >= 18 [
      hatch-workers 1 [
        set color green
        set salary (random-normal 50000 10000)
        set taxes-paid 0
      ]
      die
    ]
...
"" ""
PENS
"default" 1.0 0 -13345367 true "" "plot count youngers"
"pen-1" 1.0 0 -13840069 true "" "plot count workers"
"pen-2" 1.0 0 -2674135 true "" "plot count retireds"
